...
//Class for a point object, which will be the color data for each pixel in the image
class Point 
{
    private:
    int r; //red value
     ...
     * @returns: nothing
     *
     * Created a point object with the RGB data. Id is set to -1 if the point isnt in a cluster.
     */
